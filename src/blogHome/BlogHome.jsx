      ...
      <div className="blogHead">
        ...
        <div className="blogProfile">
          ...
          <div className="profileText">
            <p className="profileName">Nene Yashiro</p>
            <p className="profileDate">4:57 pm 10/30/2022</p>
          </div>
        </div>
        
        <img className="postImg" src="https://cdn.mos.cms.futurecdn.net/6rFtcRpN8NpKyEHASVhV5o-970-80.jpg.webp" alt=""></img>
      ...
      <div className="blogPost">
        <div className="blogProfile">
          <img className="profileImg"
                ...
                alt="" />
          <div className="profileText">
            <p className="profileName">Amane Yugi</p>
            <p className="profileDate">5:32 pm 10/30/2022</p>
          </div>
        </div>
        
        <img className="postImg" src="https://1.bp.blogspot.com/-D5CbLLfVCUE/VPro2zrcLEI/AAAAAAABVIA/2NxqCPL_k-c/s1600/Queen%2BElizabeth%2BII%2B(1).jpg" alt=""></img>
        <p className="blogTitle">Lorem Ipsum</p>
        <p className="blogBody">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eu consectetur eros. Morbi non ex sed tellus tincidunt iaculis vitae id augue. Fusce laoreet ultrices libero id tristique. Nullam scelerisque maximus rutrum. Nam eu augue non leo sollicitudin vehicula ac at neque. Integer tempor gravida ex, vitae consectetur nisi fermentum ultrices. Donec luctus elementum neque, sit amet pellentesque elit eleifend a.
        </p>
      ...
      <div className="blogPost">
        <div className="blogProfile">
          <img className="profileImg"
                ...
                alt="" />
          <div className="profileText">
            <p className="profileName">Kou Minamoto</p>
            <p className="profileDate">5:57 pm 10/30/2022</p>
          </div>
        </div>
        
        <img className="postImg" src="https://www.boredpanda.com/blog/wp-content/uploads/2022/01/61e6c042b43f1_lc3n8ty6to881__700.jpg" alt=""></img>
        <p className="blogTitle">Lorem Ipsum</p>
        <p className="blogBody">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eu consectetur eros. Morbi non ex sed tellus tincidunt iaculis vitae id augue. Fusce laoreet ultrices libero id tristique. Nullam scelerisque maximus rutrum. Nam eu augue non leo sollicitudin vehicula ac at neque. Integer tempor gravida ex, vitae consectetur nisi fermentum ultrices. Donec luctus elementum neque, sit amet pellentesque elit eleifend a.
        </p>      
