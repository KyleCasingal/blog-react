    ...
    <div className='topLanding'>
        ...
        <div className="topCenterLanding">
            <ul className="topListLanding">
                <li className="topListItemLanding" onClick={()=>{ navigate("/"); removeHeader()}}>HOME</li>
                <li className="topListItemLanding" onClick={()=>{ navigate("/AmenitiesGuest"); addHeader()}}>AMENITIES</li>
           
              <button className="registerButtonLanding" onClick={()=>{navigate("/Register");}} >
                Register your Account
              </button>
              <button className="loginButtonLanding" onClick={()=>{navigate("/Login");}} >
                Login
              </button>
            </ul>
        </div>
