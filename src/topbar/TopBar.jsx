    ...
    <div className='top'>
        ...
        <div className="topCenter">
            ...
            <ul className="topList">                             
                <li className="topListItem1" onClick={()=>{darkMode(); navigate("/")}}>HOME</li>
                <li className="topListItem1" onClick={()=>{darkMode(); navigate("/Amenities")}}>AMENITIES</li>
                <li className="topListItem1" onClick={()=>{navigate("/BlogHome")}}>BLOG</li>
                <li className="topListItem1" onClick={()=>{darkMode(); navigate("/BlogWrite")}}>WRITE</li>
            </ul>
        </div>
